/*
 * USB HID Mouse
 * modified for use with the 16f1454-bootloader
 *
...
/*
 the reference code from Signal 11 has a bevy of #pragma config options
 however, these are superfluous here, as the bootloader has already set these
 */
...
{
/*
 the reference code from Signal 11 has USB initialization code here
 this is unneeded here, as the USB bootloader has already done this for us
*/
